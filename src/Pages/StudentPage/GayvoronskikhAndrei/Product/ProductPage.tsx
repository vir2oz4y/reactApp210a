...
import GayvoronskikhCreateProductPopUp from "./Modals/GayvoronskikhCreateProductPopUp";
import GayvoronskikhEditProductPopUp from "./Modals/GayvoronskikhEditProductPopUp";
...
const ProductPage = () => {
    ...
    const getProducts = () => {
        GayvoronskikhAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/Product/list')
            .then(res => {
    ...
    const onDeleteClick = (id: number) => {
        GayvoronskikhAxios.delete(`https://canstudy.ru/orderapi/Product/${id}`)
            .then(res => {
                setProductList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <GayvoronskikhCreateProductPopUp
            ...
            {editProduct !== null && <GayvoronskikhEditProductPopUp
