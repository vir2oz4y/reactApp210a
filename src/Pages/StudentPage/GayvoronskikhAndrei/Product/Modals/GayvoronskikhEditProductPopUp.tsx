...
import GayvoronskikhPopUp, {
    IPopUp
} from "../../../../../Components/Gayvoronskikh/GayvoronskikhPopUp/GayvoronskikhPopUp";
...
const GayvoronskikhEditProductPopUp = ({open, onClose, Product:ProductEdit, onEdit}: Props) => {

    const [Product, setProduct] = useState(ProductEdit)

    const onEditClick = () => {

        GayvoronskikhAxios.patch<{ item:Product }>('https://canstudy.ru/orderapi/Product',
            {
                item:{
                    ...Product
                }
    ...
    const getCategories = () => {
        GayvoronskikhAxios<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(res => {
    ...
    const getManufacturies = () => {
        GayvoronskikhAxios.get<{ items: Manufacturer[] }>('https://canstudy.ru/orderapi/manufacturer/list')
            .then(res => {
...
export default GayvoronskikhEditProductPopUp;