...
const GayvoronskikhCreateProductPopUp = ({open, onClose, onCreate}: Props) => {

    const createProduct = () => {
        GayvoronskikhAxios.post<{ item: Product }>('https://canstudy.ru/orderapi/Product',
            {
                ...Product
            })
            .then(res => {
    ...
    const getCategories = () => {
        GayvoronskikhAxios.get<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(res => {
...
export default GayvoronskikhCreateProductPopUp;