...
const VishnyakEditClientPopup = ({open, onClose, client:clientEdit, onEdit}: Props) => {

    const [client, setClient] = useState(clientEdit)

    const onEditClick = () => {

        VishnyakAxios.patch<{ item:Client }>('https://canstudy.ru/orderapi/Client',
            {
                item:{
                    ...client
                }
...
export default VishnyakEditClientPopup;