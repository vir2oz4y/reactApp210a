...
import VishnyakCreateClientPopup from "./Modals/VishnyakCreateClientPopup";
import VishnyakEditClientPopup from "./Modals/VishnyakEditClientPopup";
...
const ClientPage = () => {
    ...
    const getClients = () => {
        VishnyakAxios.get<{ items: Client[] }>('https://canstudy.ru/orderapi/Client/list')
            .then(res => {
    ...
    const onDeleteClick = (id: number) => {
        VishnyakAxios.delete(`https://canstudy.ru/orderapi/Client/${id}`)
            .then(res => {
                setClientList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <VishnyakCreateClientPopup
            ...
            {editClient !== null && <VishnyakEditClientPopup
