...
const VishnyakCreateProductPopup = ({open, onClose, onCreate}: Props) => {

    const createProduct = () => {
        VishnyakAxios.post<{ item: Product }>('https://canstudy.ru/orderapi/Product',
            {
                ...Product
            })
            .then(res => {
    ...
    const getCategories = () => {
        VishnyakAxios.get<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(res => {
...
export default VishnyakCreateProductPopup;