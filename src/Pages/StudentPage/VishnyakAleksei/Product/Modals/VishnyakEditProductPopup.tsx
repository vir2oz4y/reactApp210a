...
const VishnyakEditProductPopup = ({open, onClose, Product:ProductEdit, onEdit}: Props) => {

    const [Product, setProduct] = useState(ProductEdit)

    const onEditClick = () => {

        VishnyakAxios.patch<{ item:Product }>('https://canstudy.ru/orderapi/Product',
            {
                item:{
                    ...Product
                }
    ...
    const getCategories = () => {
        VishnyakAxios<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(res => {
    ...
    const getManufacturies = () => {
        VishnyakAxios.get<{ items: Manufacturer[] }>('https://canstudy.ru/orderapi/manufacturer/list')
            .then(res => {
...
export default VishnyakEditProductPopup;