...
import VishnyakEditManufacturerPopup from "./Popups/VishnyakEditManufacturePopup";
import VishnyakCreateManufacturerPopup from "./Popups/VishnyakCreateManufacturePopup";
...
const ManufacturerPage = () => {
    ...
    const onDeleteClick = (id: number) => {
        VishnyakAxios.delete(`https://canstudy.ru/orderapi/manufacturer/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        VishnyakAxios.get<{ items: Manufacturer[] }>(
