...
import VishnyakPopup from "../../../../Components/Vishnyak/VishnyakPopup/VishnyakPopup";
...
const ManufacturerPage = () => {
    ...
    return (
        <div>
            ...
            {showCreateManufacture && <VishnyakCreateManufacturerPopup
                open={showCreateManufacture}
                onClose={() => setShowCreateManufacture(false)}
                onCreate={(manufacture) => onCreate(manufacture)}
            />}

            {editedManufacture !== null && <VishnyakEditManufacturerPopup
