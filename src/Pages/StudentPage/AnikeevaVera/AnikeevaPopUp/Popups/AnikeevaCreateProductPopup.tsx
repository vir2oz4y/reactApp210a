...
const AnikeevaCreateProductPopup = ({open, onClose, onCreate}: Props) => {

    const createProduct = () => {
        AnikeevaAxios.post<{ item: Product }>('https://canstudy.ru/orderapi/Product',
            {
                ...Product
            })
            .then(response => {
    ...
    const getCategories = () => {
        AnikeevaAxios.get<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(response => {
...
export default AnikeevaCreateProductPopup;