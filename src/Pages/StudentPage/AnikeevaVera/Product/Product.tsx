...
import AnikeevaCreateProductPopup from "../AnikeevaPopUp/Popups/AnikeevaCreateProductPopup";
import AnikeevaEditProductPopup from '../AnikeevaPopUp/Popups/AnikeevaEditProductPopup';
...
const Productpage = () => {
    ...
    const getProducts = () => {
        AnikeevaAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/product/list')
            .then(response => {
    ...
    const onDeleteClick = (id: number) => {
        AnikeevaAxios.delete(`https://canstudy.ru/orderapi/product/${id}`)
            .then(response => {
                setProductList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <AnikeevaCreateProductPopup
            ...
            {editProduct !== null && <AnikeevaEditProductPopup
