...
const JabrovCreateProductPopUp = ({open, onClose, onCreate}: Props) => {

    const createProduct = () => {
        JabrovAxios.post<{ item: Product }>('https://canstudy.ru/orderapi/Product',
            {
                ...Product
            })
            .then(response => {
    ...
    const getCategories = () => {
        JabrovAxios.get<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(response => {
...
export default JabrovCreateProductPopUp;