...
import JabrovCreateProductPopUp from './Modals/JabrovCreateProductPopUp';
import JabrovEditProductPopUp from './Modals/JabrovEditProductPopUp';
...
const ProductPage = () => {
    ...
    const getProducts = () => {
        JabrovAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/product/list')
            .then(response => {
    ...
    const onDeleteClick = (id: number) => {
        JabrovAxios.delete(`https://canstudy.ru/orderapi/product/${id}`)
            .then(response => {
                setProductList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <JabrovCreateProductPopUp
            ...
            {editProduct !== null && <JabrovEditProductPopUp
