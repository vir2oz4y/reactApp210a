...
const TelelinskiyEditProductPopUp = ({open, onClose, Product:ProductEdit, onEdit}: Props) => {
    ...
    const onEditClick = () => {
        ...
        TelelinskiyAxios.patch<{ item:Product }>('https://canstudy.ru/orderapi/Product',
            {
                item:{
                    ...Product
                }
    ...
    const getCategories = () => {
        TelelinskiyAxios<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(response => {
    ...
    const getManufacturies = () => {
        TelelinskiyAxios.get<{ items: Manufacturer[] }>('https://canstudy.ru/orderapi/manufacturer/list')
            .then(response => {
