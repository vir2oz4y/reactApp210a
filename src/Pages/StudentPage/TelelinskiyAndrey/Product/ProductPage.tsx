...
import TelelinskiyCreateProductPopUp from './Modals/TelelinskiyCreateProductPopUp';
import TelelinskiyEditProductPopUp from './Modals/TelelinskiyEditProductPopUp';
...
const ProductPage = () => {
    ...
    const getProducts = () => {
        TelelinskiyAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/product/list')
            .then(response => {
    ...
    const onDeleteClick = (id: number) => {
        TelelinskiyAxios.delete(`https://canstudy.ru/orderapi/product/${id}`)
            .then(response => {
                setProductList(prev =>
