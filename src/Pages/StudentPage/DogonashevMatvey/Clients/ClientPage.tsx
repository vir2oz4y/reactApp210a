...
import { DogonashevCreateClientPopUp } from './Modals/DogonashevCreateCliensPopUp';
import { DogonashevEditClientPopUp } from './Modals/DogonashevEditClientPopUp';
...
const ClientPage = () => {
    ...
    const OneDeleteClick = (id:number) => {
        ...
        DogonashevAxios.delete(`https://canstudy.ru/orderapi/client/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        DogonashevAxios.get<{ items: Client[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateClient && <DogonashevCreateClientPopUp
            ...
            {editedClient !== null && <DogonashevEditClientPopUp
