...
import { DogonashevCreateManufacturerPopUp } from './Modals/DogonashevCreateManufacturerPopUp';
import { DogonashevEditManufacturerPopUp } from './Modals/DogonashevEditManufacturerPopUp';
...
const ManufacturerPage = () => {
    ...
    const OneDeleteClick = (id: number) => {
        ...
        DogonashevAxios.delete(`https://canstudy.ru/orderapi/Manufacturer/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        DogonashevAxios.get<{ items: Manufacturer[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateManufacture && <DogonashevCreateManufacturerPopUp
            ...
            {editedManufacture !== null && <DogonashevEditManufacturerPopUp
