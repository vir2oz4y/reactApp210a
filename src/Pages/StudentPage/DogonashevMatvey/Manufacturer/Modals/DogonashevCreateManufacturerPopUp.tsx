...
export const DogonashevCreateManufacturerPopUp = ({ open, onClose, onCreate }: Props) => {
    ...
    const onCreateClick = () => {
        DogonashevAxios.post<{ item: Manufacturer }>('https://canstudy.ru/orderapi/manufacturer',
            {
