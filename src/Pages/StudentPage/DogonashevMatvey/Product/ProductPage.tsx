...
import DogonashevCreateProductPopUp from './Modals/DogonashevCreateProductPopUp';
import DogonashevEditProductPopUp from './Modals/DogonashevEditProductPopUp';
...
const ProductPage = () => {
    ...
    const getProducts = () => {
        DogonashevAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/product/list')
            .then(response => {
    ...
    const onDeleteClick = (id: number) => {
        DogonashevAxios.delete(`https://canstudy.ru/orderapi/product/${id}`)
            .then(response => {
                setProductList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <DogonashevCreateProductPopUp
            ...
            {editProduct !== null && <DogonashevEditProductPopUp
