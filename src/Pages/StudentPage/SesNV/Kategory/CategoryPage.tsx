...
import {SesCreatCategory} from "./modals/SesCreatCategory";
import { sesAxios } from '../SesNV';
import { SesEditCategory } from './modals/SesEditCategory';
const CategoryPage = () => {
    ...
    const onDeleteClick = (id: number) => {
        ...
        sesAxios.delete(`https://canstudy.ru/orderapi/category/${id}`)
            .then(() => {
                setCategories(prev =>
    ...
    return (
        <div>
            ...
            {showCreateCategory && <SesCreatCategory
                open={showCreateCategory}
                onClose={() => setShowCreateCategory(false)}
                onCreate={(category) => onCreate(category)}
            />}

            {editedCategory !== null && <SesEditCategory
