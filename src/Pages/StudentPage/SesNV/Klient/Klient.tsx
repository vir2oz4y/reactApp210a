...
import SesCreateClientPopup from "./popup/SesCreateClientPopup";
import SesEditClientPopup from "./popup/SesEditClientPopup";
...
const ClientPage = () => {
    ...
    const getClients = () => {
        sesAxios.get<{ items: Client[] }>('https://canstudy.ru/orderapi/Client/list')
            .then(res => {
    ...
    const onDeleteClick = (id: number) => {
       sesAxios.delete(`https://canstudy.ru/orderapi/Client/${id}`)
            .then(res => {
                setClientList(prev =>
    ...
    return (
        <div style={{ width: '100%' }}>
            ...
            {createPopupOpened && <SesCreateClientPopup
            ...
            {editClient !== null && <SesEditClientPopup
