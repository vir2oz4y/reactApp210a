...
import { TatarnikovCreateManufacturerPopUp} from "./Modals/TatarnikovCreateManufacturerPopUp";
import { TatarnikovEditManufacturerPopUp} from "./Modals/TatarnikovEditManufacturerPopUp";
...
const ManufacturerPage = () => {
    ...
    const OneDeleteClick = (id: number) => {
        ...
        TatarnikovAxios.delete(`https://canstudy.ru/orderapi/Manufacturer/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        TatarnikovAxios.get<{ items: Manufacturer[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateManufacture && <TatarnikovCreateManufacturerPopUp
            ...
            {editedManufacture !== null && <TatarnikovEditManufacturerPopUp
