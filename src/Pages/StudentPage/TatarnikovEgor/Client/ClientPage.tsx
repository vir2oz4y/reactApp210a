...
import { TatarnikovCreateClientPopUp} from "./Modals/TatarnikovCreateClientPopUp";
import { TatarnikovEditClientPopUp} from "./Modals/TatarnikovEditClientPopUp";
...
const ClientPage = () => {
    ...
    const OneDeleteClick = (id:number) => {
        ...
        TatarnikovAxios.delete(`https://canstudy.ru/orderapi/client/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        TatarnikovAxios.get<{ items: Client[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateClient && <TatarnikovCreateClientPopUp
            ...
            {editedClient !== null && <TatarnikovEditClientPopUp
