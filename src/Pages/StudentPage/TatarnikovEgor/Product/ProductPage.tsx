...
import TatarnikovCreateProductPopUp from "./Modals/TatarnikovCreateProductPopUp";
import TatarnikovEditProductPopUp from "./Modals/TatarnikovEditProductPopUp";
...
const ProductPage = () => {
    ...
    const getProducts = () => {
        TatarnikovAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/product/list')
            .then(response => {
    ...
    const onDeleteClick = (id: number) => {
        TatarnikovAxios.delete(`https://canstudy.ru/orderapi/product/${id}`)
            .then(response => {
                setProductList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <TatarnikovCreateProductPopUp
            ...
            {editProduct !== null && <TatarnikovEditProductPopUp
