...
const BushmanovCreateProductPopup = ({open, onClose, onCreate}: Props) => {

    const createProduct = () => {
        bushmanovAxios.post<{ item: Product }>('https://canstudy.ru/orderapi/Product',
            {
                ...Product
            })
            .then(response => {
    ...
    const getCategories = () => {
        bushmanovAxios.get<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(response => {
...
export default BushmanovCreateProductPopup;