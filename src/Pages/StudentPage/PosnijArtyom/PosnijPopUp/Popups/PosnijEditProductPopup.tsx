...
const PosnijEditProductPopup = ({open, onClose, Product:ProductEdit, onEdit}: Props) => {

    const [Product, setProduct] = useState(ProductEdit)

    const onEditClick = () => {

        posnijAxios.patch<{ item:Product }>('https://canstudy.ru/orderapi/Product',
            {
                item:{
                    ...Product
                }
    ...
    const getCategories = () => {
        posnijAxios<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(response => {
...
export default PosnijEditProductPopup;