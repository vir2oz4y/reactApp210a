...
import PosnijCreateProductPopup from "../PosnijPopUp/Popups/PosnijCreateProductPopup";
import PosnijEditProductPopup from '../PosnijPopUp/Popups/PosnijEditProductPopup';
...
const Productpage = () => {
    ...
    const getProducts = () => {
        posnijAxios.get<{ items: Product[] }>('https://canstudy.ru/orderapi/product/list')
            .then(response => {
    ...
    const onDeleteClick = (id: number) => {
        posnijAxios.delete(`https://canstudy.ru/orderapi/product/${id}`)
            .then(response => {
                setProductList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <PosnijCreateProductPopup
            ...
            {editProduct !== null && <PosnijEditProductPopup
