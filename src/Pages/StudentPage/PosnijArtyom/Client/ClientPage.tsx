...
import { PosnijCreateClientPagePopup } from '../PosnijPopUp/Popups/PosnijCreateClientPopup';
import {PosnijEditClientPagePopup} from "../PosnijPopUp/Popups/PosnijEditClientPopup";
...
const ClientPage = () => {
    ...
    const OneDeleteClick = (id:number) => {
        ...
        posnijAxios.delete(`https://canstudy.ru/orderapi/client/${id}`)
            .then(() => {
    ...
    return (
        <div>
            ...
            {ShowCreateClient && <PosnijCreateClientPagePopup
            ...
            {editedClient !== null && <PosnijEditClientPagePopup
