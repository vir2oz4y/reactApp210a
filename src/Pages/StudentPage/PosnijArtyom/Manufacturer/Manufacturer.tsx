...
import PosnijPopUp from "../PosnijPopUp/PosnijPopUp";
import { PosnijCreateManufacturePagePopup } from '../PosnijPopUp/Popups/PosnijCreateManufacturePopup';
import {PosnijEditManufacturePagePopup} from "../PosnijPopUp/Popups/PosnijEditManufacturePopup";
...
const ManufacturePage = () => {
    ...
    const OneDeleteClick = (id: number) => {
        ...
        posnijAxios.delete(`https://canstudy.ru/orderapi/Manufacturer/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        posnijAxios.get<{ items: Manufacture[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateManufacture && <PosnijCreateManufacturePagePopup
            ...
            {editedManufacture !== null && <PosnijEditManufacturePagePopup
