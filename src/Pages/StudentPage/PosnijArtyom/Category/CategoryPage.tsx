...
import { PosnijCreateCategoryPagePopup } from '../PosnijPopUp/Popups/PosnijCreateCategoryPopup';
import {PosnijEditCategoryPagePopup} from "../PosnijPopUp/Popups/PosnijEditCategoryPopup";
...
const CategoryPage = () => {
    ...
    const OneDeleteClick = (id: number) => {
        ...
        posnijAxios.delete(`https://canstudy.ru/orderapi/category/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        posnijAxios.get<{ items: Category[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateCategory && <PosnijCreateCategoryPagePopup
            ...
            {editedCategory !== null && <PosnijEditCategoryPagePopup
