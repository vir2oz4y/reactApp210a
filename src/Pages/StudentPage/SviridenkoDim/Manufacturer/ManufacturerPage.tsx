...
const ManufacturerPage = () => {
    ...
    const OneDeleteClick = (id: number) => {
        ...
        SviridenkoAxios.delete(`https://canstudy.ru/orderapi/Manufacturer/${id}`)
            .then(() => {
    ...
    useEffect(() => {
        SviridenkoAxios.get<{ items: Manufacturer[] }>(
    ...
    return (
        <div>
            ...
            {ShowCreateManufacture && <SviridenkoCreateManufacturer
