...
const PayzunovEditProductPopup = ({open, onClose, Product:ProductEdit, onEdit}: Props) => {

    const [Product, setProduct] = useState(ProductEdit)

    const onEditClick = () => {

        PayzunovAxios.patch<{ item:Product }>('https://canstudy.ru/orderapi/Product',
            {
                item:{
                    ...Product
                }
    ...
    const getCategories = () => {
        PayzunovAxios<{ items: Category[] }>('https://canstudy.ru/orderapi/category/list')
            .then(res => {
...
export default PayzunovEditProductPopup;