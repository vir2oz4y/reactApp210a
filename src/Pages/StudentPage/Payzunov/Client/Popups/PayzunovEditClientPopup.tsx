...
const PayzunovEditClientPopup = ({open, onClose, client:clientEdit, onEdit}: Props) => {

    const [client, setClient] = useState(clientEdit)

    const onEditClick = () => {

        PayzunovAxios.patch<{ item:Client }>('https://canstudy.ru/orderapi/Client',
            {
                item:{
                    ...client
                }
...
export default PayzunovEditClientPopup;