...
const BurlakCreateClientPopup = ({open, onClose, onCreate}: Props) => {

    const createClient = () => {
        BurlakAxios.post<{ item:Client }>('https://canstudy.ru/orderapi/Client',
            {
                ...client
            })
            .then(res => {
...
export default BurlakCreateClientPopup;