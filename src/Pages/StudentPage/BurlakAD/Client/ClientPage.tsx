...
const ClientPage = () => {
    ...
    const getClients = () => {
        BurlakAxios.get<{ items: Client[] }>('https://canstudy.ru/orderapi/Client/list')
            .then(res => {
    ...
    const onDeleteClick = (id: number) => {
        BurlakAxios.delete(`https://canstudy.ru/orderapi/Client/${id}`)
            .then(res => {
                setClientList(prev =>
    ...
    return (
        <div style={{width: '100%'}}>
            ...
            {createPopupOpened && <BurlakCreateClientPopup
            ...
            {editClient !== null && <BurlakEditClientPopup
