...
import { BurlakCreateCategoryPopup } from './Popups/BurlakCreateCategoryPopup';
import { BurlakEditCategoryPopup } from "./Popups/BurlakEditCategoryPopup";
...
const CategoryPage = () => {
    ...
    const onDeleteClick = (id: number) => {
        ...
        BurlakAxios.delete(`https://canstudy.ru/orderapi/category/${id}`)
            .then(() => {
                setCategories(prev =>
    ...
    useEffect(() => {
        BurlakAxios.get<{ items: Category[] }>(
    ...
    return (
        <div>
            ...
            {showCreateCategory && <BurlakCreateCategoryPopup
                open={showCreateCategory}
                onClose={() => setShowCreateCategory(false)}
                onCreate={(category) => onCreate(category)}
            />}

            {editedCategory !== null && <BurlakEditCategoryPopup
