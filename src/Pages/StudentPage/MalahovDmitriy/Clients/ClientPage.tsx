...
const ClientPage = () => {
    ...
    const [client, setClient] = useState<Client[]>([
        { id: 1, sex: 'male', firstName: 'Dimtry', lastName: 'Malahov', email: 'Sibstrin.ru', phoneNumber: '4' },
    ]);
    ...
    return (
        <div>
            ...
            {showCreateClient && <MalahovCreateClientPopup
            ...
            {editedClient !== null && <MalahovEditClientPopup
